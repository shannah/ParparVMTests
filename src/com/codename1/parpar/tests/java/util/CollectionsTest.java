...
public class CollectionsTest extends AbstractTest {
    ...
    public void rotates() {
        ...
        assertArrayEqual(new Integer[] { 5, 6, 2, 5, 7, 3 }, list.toArray(new Integer[list.size()]));
    }
    ...
    public void replaces() {
        ...
        assertArrayEqual(new Integer[] { 2, 9, 7, 3, 9, 6 }, list.toArray(new Integer[list.size()]));
    }
